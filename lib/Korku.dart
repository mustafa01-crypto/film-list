...
class Korku extends StatefulWidget {
  @override
  _KorkuState createState() => _KorkuState();
}

class _KorkuState extends State<Korku> {

  Future<List<Filmler>> korkuGetir() async {

    var filmListe = List<Filmler>();

    var f1 = Filmler(1, "Django", "django.png", 12);
    var f2 = Filmler(1, "Hateful Eight", "thehatefuleight.png", 14.99);
